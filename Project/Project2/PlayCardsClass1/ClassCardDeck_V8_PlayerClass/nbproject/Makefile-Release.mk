...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/classcarddeck_v8_playerclass.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/classcarddeck_v8_playerclass.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/classcarddeck_v8_playerclass ${OBJECTFILES} ${LDLIBSOPTIONS}
